#This is the same code as DomainWall.py but with mu fixed. We can specify mu before hand.
#------------------------------------------------------------------------------------------------------
...
T11 = float(0.0)  # float(input("Enter T11: "))
T12 = float(0.0)  # float(input("Enter T12: "))
T21 = float(0.0)  # float(input("Enter T21: "))
T22 = float(0.0)  # float(input("Enter T22: "))
...
G = np.array([[K11,K12,T11,T21],[K12,K22,T12,T22],[T11,T12,1.0,0.0],[T21,T22,0.0,1.0]])
print(is_pos_def(G))
if is_pos_def(G):
...
print("dKd, T2, T1, K1 = ", dKd, T2, T1, K1)
