...
for i, t in enumerate(loading):
    ...
    plt.xlabel("x [mm]")
    plt.ylabel("y [mm]")
    plt.title("Damage  t={:.4f} mm".format(t))
...
plt.xlabel("Imposed displacement [mm]")
...
plt.xlabel("Imposed displacement s[te thickness doesntmm]")
plt.ylabel("Energy [mJ]")
plt.legend()
plt.title("Energy evolution")
plt.show()

#Stress evolution at crack tiMPa
...
plt.ylabel(r"Stress at crack tip [MPa]")
...
plt.xlabel("Applied displacement [mm]")
plt.ylabel(r"Stress at left end [MPa]")
