...
vtkfile = File("ThermoElastic2Figures/2DThermoElastic_Temp.pvd")
vtkfile << Delta_T
...
U2 =u[1]
w0 = project(U2, V)
vtkfile = File('ThermoElastic2Figures/2Ddisp_NoForce.pvd')
vtkfile << w0
...
U2 =u[1]
w0 = project(U2, V)
vtkfile = File('ThermoElastic2Figures/2Ddisp_YesForce.pvd')
vtkfile << w0
